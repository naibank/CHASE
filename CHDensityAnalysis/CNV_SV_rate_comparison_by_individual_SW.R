################################################################################################################################################################################
# 
# CNV_SV_rate_comparison_by_individual_SW.R
# purpose: - creates CH_hits tables (CH hit and total deleted exonic size tables)
#          - plots MSSNG+SSC linear del size vs. CH count plots
#          - outputs MSSNG+SSC Fisher's test results using linear observed line as cut-off 
# input: MSSNG & SSC metadata, CRVs, excluded.qcfailed.samples.txt, parent_proband_SNVsExonicSizes.yaml
#         /hpf/largeprojects/tcagstor/tcagstor_tmp/shania.wu/MSSNG+SSC/MSSNG+SSC_BA/data/
# output: MSSNG+SSC del size vs. CH count plots & Fisher's test results using linear 
...
MSSNG_male_proband_IDs <- MSSNG_meta$Sample.ID[MSSNG_meta$Relation == 'proband' &
                                                 MSSNG_meta$Sex == "male"]
MSSNG_female_proband_IDs <- MSSNG_meta$Sample.ID[MSSNG_meta$Relation == 'proband'&
                                                   MSSNG_meta$Sex == "female"]
...
SSC_male_proband_IDs <- SSC_meta$Sample.ID[SSC_meta$Relation == 'proband' &
                                             SSC_meta$Sex == "male"]
SSC_female_proband_IDs <- SSC_meta$Sample.ID[SSC_meta$Relation == 'proband' &
                                             SSC_meta$Sex == "female"]
...
#### MSSNG 
MSSNG_CH_hits_nofilt <- Get_CH_hit_By_Individual_ExonicSize(SNVs=MSSNG_parent_proband_proc_SNVs,
                                                            exonic_sizes=MSSNG_parent_proband_all_ExonicSizes,
                                                            M.proband_IDs=MSSNG_male_proband_IDs, 
                                                            F.proband_IDs=MSSNG_female_proband_IDs,
                                                            MSSNG_father_IDs, MSSNG_mother_IDs,
                                                            filter_SNV = F)
...
SSC_CH_hits_nofilt <- Get_CH_hit_By_Individual_ExonicSize(SSC_parent_proband_proc_SNVs,
                                                          ...
                                                          M.proband_IDs=SSC_male_proband_IDs, 
                                                          F.proband_IDs=SSC_female_proband_IDs,
                                                          SSC_father_IDs, SSC_mother_IDs,
                                                          filter_SNV = F)
...
write.table(MSSNG_SSC_CH_hits_nofilt, "./CH_count_del_size/data/CH_hits/MSSNG_SSC_CH_hits_nofilt_sex.tsv",  
...
write.table(MSSNG_SSC_CH_hits_pRec, "./CH_count_del_size/data/CH_hits/MSSNG_SSC_CH_hits_pRec_sex.tsv",  
            sep="\t", row.names=F, quote=F, col.names=T)
