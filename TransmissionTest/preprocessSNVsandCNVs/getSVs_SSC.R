...
tmp <- CNVfilter.procedure("/hpf/largeprojects/tcagstor/tcagstor_tmp/farazali/SSC/SVs/SVs.SSC.freq_1percent.HQR.IntFreq.tsv")

write.table(tmp, "./SSC.SVs.freq.1perc.tsv", sep="\t", row.names=F, quote=F, col.names=T)
