...
tmp <- fread("/hpf/largeprojects/tcagstor/tcagstor_tmp/farazali/SSC/CNVs/CNVs.SSC.freq_10percent.HQR.IntFreq.tsv", data.table = F)
...
write.table(tmp, "./SSC.CNVs.freq.1perc.tsv", sep="\t", row.names=F, quote=F, col.names=T)
