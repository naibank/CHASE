...
tmp <- fread("/hpf/largeprojects/tcagstor/tcagstor_tmp/farazali/SSC/CNVs/CNVs.SSC.freq_10percent.HQR.tsv", data.table = F)
...
write.table(tmp, "./SSC.CNVs.freq.10perc.tsv", sep="\t", row.names=F, quote=F, col.names=T)
