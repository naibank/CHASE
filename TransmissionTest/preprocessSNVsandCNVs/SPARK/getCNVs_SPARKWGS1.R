...
tmp <- fread("/hpf/largeprojects/tcagstor/tcagstor_tmp/farazali/SPARK_WGS_1/CNVs/CNVs.SPARK_WGS_1.freq_1percent.HQR.tsv", data.table = F)
...
write.table(tmp, "./SPARKWGS1.CNVs.freq.1perc.tsv", sep="\t", row.names=F, quote=F, col.names=T)
