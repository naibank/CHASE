...
tmp <- fread("/hpf/largeprojects/tcagstor/tcagstor_tmp/farazali/SPARK_WGS_3/CNVs/CNVs.SPARK_WGS_3.freq_1percent.HQR.tsv", data.table = F)
...
write.table(tmp, "./SPARKWGS3.CNVs.freq.1perc.tsv", sep="\t", row.names=F, quote=F, col.names=T)
