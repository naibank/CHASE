...
Create_TT_Result_Plot <- function(df, df_text, title, name, save_path='../TT/FinalPresPlots/') {
...
SPARK_SNV_100P_TT_df <- Load_TTRes_DF('../TT/Combined Data/SPARK/ SPARK_proband_FisherTest_eventfreq.tsv')
SPARK_SNV_100P_TT_df$SNV_freq <- 1
SPARK_SNV_10P_TT_df <- Load_TTRes_DF('../TT/Combined Data/SPARK/SNV0.1/ SPARK_proband_FisherTest_eventfreq_snvfreq0.1.tsv')
SPARK_SNV_10P_TT_df$SNV_freq <- 2
SPARK_SNV_1P_TT_df <- Load_TTRes_DF('../TT/Combined Data/SPARK/SNV0.01/ SPARK_proband_FisherTest_eventfreq_snvfreq0.01.tsv')
...
SPARKUS_SNV_100P_TT_df <- Load_TTRes_DF('../TT/Combined Data/SPARK/ SPARK_unaffected_sibling_FisherTest_eventfreq.tsv')
SPARKUS_SNV_100P_TT_df$SNV_freq <- 1
SPARKUS_SNV_10P_TT_df <- Load_TTRes_DF('../TT/Combined Data/SPARK/SNV0.1/ SPARK_unaffected_sibling_FisherTest_eventfreq_snvfreq0.1.tsv')
SPARKUS_SNV_10P_TT_df$SNV_freq <- 2
SPARKUS_SNV_1P_TT_df <- Load_TTRes_DF('../TT/Combined Data/SPARK/SNV0.01/ SPARK_unaffected_sibling_FisherTest_eventfreq_snvfreq0.01.tsv')
