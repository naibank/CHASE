...
unaffsib_table <- fread("/Users/shaniawu/SickKids CHASE/SSC/data/SSC_unaffected_sibling_CNV_SNV_table_eventfreq.tsv", data.table = F)
...
for (gset in c("FMR1_Targets_Ascano", "PhMm_Aggr_CardvascMuscle_all")) {
  ...
  related_target_unaffsib <- intersect(related_unaffdsib, target_unaffsib$`#Sample`)
