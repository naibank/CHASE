...
proband_table <- rbind(fread("./SPARK/SPARKWGS1_proband_CNV_SNV_table.tsv", data.table = F),
                       fread("./SPARK/SPARKWGS2_proband_CNV_SNV_table.tsv", data.table = F),
                       fread("./SPARK/SPARKWGS3_proband_CNV_SNV_table.tsv", data.table = F))
...
cnv <- rbind(fread("./SPARK/SPARKWGS1.CNVs.freq.1perc.tsv", data.table = F),
             fread("./SPARK/SPARKWGS2.CNVs.freq.1perc.tsv", data.table = F),
             fread("./SPARK/SPARKWGS3.CNVs.freq.1perc.tsv", data.table = F))
...
write.table(proband_table, "./SPARK/SPARK_proband_CNV_SNV_table_eventfreq.tsv", sep="\t", row.names=F, quote=F, col.names=T)
...
unaffectedsib_table <- rbind(fread("./SPARK/SPARKWGS1_unaffected_sibling_CNV_SNV_table.tsv", data.table = F),
                       fread("./SPARK/SPARKWGS2_unaffected_sibling_CNV_SNV_table.tsv", data.table = F),
                       fread("./SPARK/SPARKWGS3_unaffected_sibling_CNV_SNV_table.tsv", data.table = F))
...
write.table(unaffectedsib_table, "./SPARK/SPARK_unaffected_sibling_CNV_SNV_table_eventfreq.tsv", sep="\t", row.names=F, quote=F, col.names=T)
