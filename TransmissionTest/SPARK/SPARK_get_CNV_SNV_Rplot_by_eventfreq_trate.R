...
proband_table <- fread("./SPARK/SPARK_proband_CNV_SNV_table_eventfreq.tsv", data.table = F)
...
for(freq in c(0.01, 0.005, 0.001, 0.0005, 0.0001)){ # event freq cut-offs
  ...
  for(pRecx in c(0, 0.5, 0.9)){ # pRec cut-offs
    ...
    plot_name =  paste("../TT/Combined Data/SPARK/SPARK_proband_eventfreq", freq, "_pRec", pRecx, "_trate", sep="")###Bank
...
unaffectedsib_table <- fread("./SPARK/SPARK_unaffected_sibling_CNV_SNV_table_eventfreq.tsv", data.table = F)
...
for(freq in c(0.01, 0.005, 0.001, 0.0005, 0.0001)){ # event freq cut-offs
  ...
  for(pRecx in c(0, 0.5, 0.9)){ # pRec cut-offs
    ...
    plot_name =  paste("../TT/Combined Data/SPARK/SPARK_unaffectedsibling_eventfreq", freq, "_pRec", pRecx, "_trate", sep="")
