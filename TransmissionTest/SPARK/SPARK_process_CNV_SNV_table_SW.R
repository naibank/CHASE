################################################################################################################################################################################
# 
# SPARK_process_CNV_SNV_table_SW.R
# purpose: add CH event frequency column to SPARK CNV_SNV_tables
# input:PARKWGS*1-3*_proband_CNV_SNV_table.tsv, SPARKWGS*1-3*.CNVs.freq.1perc.tsv
...
# output: SPARK_proband_CNV_SNV_table_eventfreq.tsv, SPARK_unaffected_sibling_CNV_SNV_table_eventfreq.tsv
#             -> used as input for SPARK_get_FisherTest_snvfreq_SW.R
# 
# notes:
#
##############################################################################################################################################################################
