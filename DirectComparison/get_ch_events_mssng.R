...
CNVs_10Percent <- CNVfilter.procedure(CNVfile.path = "/hpf/largeprojects/tcagstor/tcagstor_tmp/farazali/MSSNG/CNVs.ILMN/CNVs.MSSNG_ILMN.freq_10percent.HQR.tsv")

# Getting CNVs (with different MAF limits) for samples sequenced by CG platform
CNVs_10Percent.CG <- CNVfilter.procedure(CNVfile.path = "/hpf/largeprojects/tcagstor/tcagstor_tmp/farazali/MSSNG/CNVs.CG/CNVs.MSSNG_CG.freq_10percent.HQR.tsv")
