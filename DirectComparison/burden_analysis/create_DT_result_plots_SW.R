################################################################################################################################################################################
#
# create_DT_result_plots_SW.R
# purpose: outputs burden analysis logistic regression results as p-value plots (Faraz final pres.)
# input: logreg result tables ending with ...clogit_res.csv
...
# output: saves SNV MAF vs. p-value plots for each data set and comparison to 
#         /hpf/largeprojects/tcagstor/tcagstor_tmp/shania.wu/MSSNG+SSC/MSSNG+SSC_BA/figures/Pval plots/
#   -> Faraz final presentation plots
#
################################################################################################################################################################################
...
setwd("~/hpf/largeprojects/tcagstor/tcagstor_tmp/shania.wu/MSSNG+SSC/MSSNG+SSC_BA")
...
Create_DT_Result_Plot <- function(df, df_text, title, name, save_path='./figures/Pval plots/') {
...
# MSSNG_SNV_100P_regres_df <- Load_LogRegRes_DF('./data/LogRegResults/MSSNG_parent_proband_clogit_res.csv')
# MSSNG_SNV_100P_regres_df$SNV_freq <- 1
# MSSNG_SNV_10P_regres_df <- Load_LogRegRes_DF('./data/LogRegResults/MSSNG_parent_proband_SNV10p_clogit_res.csv')
# MSSNG_SNV_10P_regres_df$SNV_freq <- 2
# MSSNG_SNV_1P_regres_df <- Load_LogRegRes_DF('./data/LogRegResults/MSSNG_parent_proband_SNV1p_clogit_res.csv')
...
# SSC_SNV_100P_regres_df <- Load_LogRegRes_DF('./data/LogRegResults/SSC_parent_proband_clogit_res.csv')
# SSC_SNV_100P_regres_df$SNV_freq <- 1
# SSC_SNV_10P_regres_df <- Load_LogRegRes_DF('./data/LogRegResults/SSC_parent_proband_SNV10p_clogit_res.csv')
# SSC_SNV_10P_regres_df$SNV_freq <- 2
# SSC_SNV_1P_regres_df <- Load_LogRegRes_DF('./data/LogRegResults/SSC_parent_proband_SNV1p_clogit_res.csv')
...
#### MSSNG.SSC parent-proband Results ####
MSSNG.SSC_SNV_100P_regres_df <- Load_LogRegRes_DF('./data/LogRegResults/MSSNG.SSC_parent_proband_clogit_res.csv')
MSSNG.SSC_SNV_100P_regres_df$SNV_freq <- 1
MSSNG.SSC_SNV_10P_regres_df <- Load_LogRegRes_DF('./data/LogRegResults/MSSNG.SSC_parent_proband_SNV10p_clogit_res.csv')
MSSNG.SSC_SNV_10P_regres_df$SNV_freq <- 2
MSSNG.SSC_SNV_1P_regres_df <- Load_LogRegRes_DF('./data/LogRegResults/MSSNG.SSC_parent_proband_SNV1p_clogit_res.csv')
MSSNG.SSC_SNV_1P_regres_df$SNV_freq <- 3

MSSNG.SSC_regres_df <- rbind(MSSNG.SSC_SNV_100P_regres_df,MSSNG.SSC_SNV_10P_regres_df,MSSNG.SSC_SNV_1P_regres_df)
MSSNG.SSC_text_regres_df <- Get_Interpolated_Text_DF(MSSNG.SSC_regres_df, 50)

# MSSNG.SSC_regres_df <- MSSNG.SSC_regres_df[MSSNG.SSC_regres_df$Variant.Type != 'LoF',]
# MSSNG.SSC_text_regres_df <- MSSNG.SSC_text_regres_df[MSSNG.SSC_text_regres_df$Variant.Type != 'LoF',]

Create_DT_Result_Plot(MSSNG.SSC_regres_df, MSSNG.SSC_text_regres_df, 'MSSNG.SSC Parent-Proband', 'MSSNG.SSC_regresP')

#### SSC parent-US Results ####
SSCUS_SNV_100P_regres_df <- Load_LogRegRes_DF('./data/LogRegResults/SSC_parent_US_clogit_res.csv')
SSCUS_SNV_100P_regres_df$SNV_freq <- 1
SSCUS_SNV_10P_regres_df <- Load_LogRegRes_DF('./data/LogRegResults/SSC_parent_US_SNV10p_clogit_res.csv')
SSCUS_SNV_10P_regres_df$SNV_freq <- 2
SSCUS_SNV_1P_regres_df <- Load_LogRegRes_DF('./data/LogRegResults/SSC_parent_US_SNV1p_clogit_res.csv')
...
SSCprobUS_SNV_100P_regres_df <- Load_LogRegRes_DF('./data/LogRegResults/SSC_proband_US_clogit_res.csv', add_cols = F)
SSCprobUS_SNV_100P_regres_df$SNV_freq <- 1
SSCprobUS_SNV_10P_regres_df <- Load_LogRegRes_DF('./data/LogRegResults/SSC_proband_US_SNV10p_clogit_res.csv', add_cols = F)
SSCprobUS_SNV_10P_regres_df$SNV_freq <- 2
SSCprobUS_SNV_1P_regres_df <- Load_LogRegRes_DF('./data/LogRegResults/SSC_proband_US_SNV1p_clogit_res.csv', add_cols = F)
...
# SPARK_SNV_100P_regres_df <- Load_LogRegRes_DF('./data/LogRegResults/SPARK_parent_proband_clogit_res.csv')
# SPARK_SNV_100P_regres_df$SNV_freq <- 1
# SPARK_SNV_10P_regres_df <- Load_LogRegRes_DF('./data/LogRegResults/SPARK_parent_proband_SNV10P_clogit_res.csv')
# SPARK_SNV_10P_regres_df$SNV_freq <- 2
# SPARK_SNV_1P_regres_df <- Load_LogRegRes_DF('./data/LogRegResults/SPARK_parent_proband_SNV1P_clogit_res.csv')
...
# SPARKUS_SNV_100P_regres_df <- Load_LogRegRes_DF('./data/LogRegResults/SPARK_parent_US_clogit_res.csv')
# SPARKUS_SNV_100P_regres_df$SNV_freq <- 1
# SPARKUS_SNV_10P_regres_df <- Load_LogRegRes_DF('./data/LogRegResults/SPARK_parent_US_SNV10P_clogit_res.csv')
# SPARKUS_SNV_10P_regres_df$SNV_freq <- 2
# SPARKUS_SNV_1P_regres_df <- Load_LogRegRes_DF('./data/LogRegResults/SPARK_parent_US_SNV1P_clogit_res.csv')
...
# SPARKprobUS_SNV_100P_regres_df <- Load_LogRegRes_DF('./data/LogRegResults/SPARK_proband_US_clogit_res.csv', add_cols = F)
# SPARKprobUS_SNV_100P_regres_df$SNV_freq <- 1
# SPARKprobUS_SNV_10P_regres_df <- Load_LogRegRes_DF('./data/LogRegResults/SPARK_proband_US_SNV10P_clogit_res.csv', add_cols = F)
# SPARKprobUS_SNV_10P_regres_df$SNV_freq <- 2
# SPARKprobUS_SNV_1P_regres_df <- Load_LogRegRes_DF('./data/LogRegResults/SPARK_proband_US_SNV1P_clogit_res.csv', add_cols = F)
