...
SPARKWGS2_meta <- Get_Filtered_Metadata(SPARKWGS2_metadata_path, child_relation = 'unaffected sibling')

SPARKWGS2_CNV_data <- yaml::yaml.load_file("SPARKWGS2_US_CH_Data_CNV1P_SNV.yaml")
...
SPARKWGS2_parent_proband_SNVsExonicSizes <- Process_Parent_Child_CNV_SNV_Data(SPARKWGS2_all_data,
                                                                              ...
                                                                              ds='SSC')
write_yaml(SPARKWGS2_parent_proband_SNVsExonicSizes, "SPARKWGS2_parent_US_SNVsExonicSizes.yaml")
