...
SPARKWGS3_meta <- Get_Filtered_Metadata(SPARKWGS3_metadata_path, child_relation = 'proband')

SPARKWGS3_CNV_data <- yaml::yaml.load_file("SPARKWGS3_CH_Data_CNV1P_SNV.yaml")
...
SPARKWGS3_parent_proband_SNVsExonicSizes <- Process_Parent_Child_CNV_SNV_Data(SPARKWGS3_all_data,
                                                                              ...
                                                                              ds='SSC')
write_yaml(SPARKWGS3_parent_proband_SNVsExonicSizes, "SPARKWGS3_parent_proband_SNVsExonicSizes.yaml")
