...
SPARKWGS1_meta <- Get_Filtered_Metadata(SPARKWGS1_metadata_path, child_relation = 'proband')

SPARKWGS1_CNV_data <- yaml::yaml.load_file("SPARKWGS1_CH_Data_CNV1P_SNV.yaml")
...
SPARKWGS1_parent_proband_SNVsExonicSizes <- Process_Parent_Child_CNV_SNV_Data(SPARKWGS1_all_data,
                                                                        ...
                                                                        ds='SSC')
write_yaml(SPARKWGS1_parent_proband_SNVsExonicSizes, "SPARKWGS1_parent_proband_SNVsExonicSizes.yaml")
