...
### SPARKWGS1 CNV Parent-Proband
SPARKWGS1_metadata_path <- './Data/SPARK_WGS_1_metadata_relfixed.tsv'
SPARKWGS1_meta <- Get_Filtered_Metadata(SPARKWGS1_metadata_path, child_relation = 'unaffected sibling')

SPARKWGS1_CNV_data <- yaml::yaml.load_file("SPARKWGS1_US_CH_Data_CNV1P_SNV.yaml")
SPARKWGS1_all_data <- list(SPARKWGS1_CNV_data)
SPARKWGS1_parent_proband_SNVsExonicSizes <- Process_Parent_Child_CNV_SNV_Data(SPARKWGS1_all_data,
                                                                              SPARKWGS1_meta,
                                                                              gene_exon_data,
                                                                              CNV_freq_filter=0.01,
                                                                              ds='SSC')
write_yaml(SPARKWGS1_parent_proband_SNVsExonicSizes, "SPARKWGS1_parent_US_SNVsExonicSizes.yaml")
