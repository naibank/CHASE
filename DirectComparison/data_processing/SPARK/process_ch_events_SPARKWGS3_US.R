...
### SPARKWGS3 CNV Parent-Proband
SPARKWGS3_metadata_path <- './Data/SPARK_WGS_3_metadata_relfixed.tsv'
SPARKWGS3_meta <- Get_Filtered_Metadata(SPARKWGS3_metadata_path, child_relation = 'unaffected sibling')

SPARKWGS3_CNV_data <- yaml::yaml.load_file("SPARKWGS3_US_CH_Data_CNV1P_SNV.yaml")
SPARKWGS3_all_data <- list(SPARKWGS3_CNV_data)
SPARKWGS3_parent_proband_SNVsExonicSizes <- Process_Parent_Child_CNV_SNV_Data(SPARKWGS3_all_data,
                                                                              SPARKWGS3_meta,
                                                                              gene_exon_data,
                                                                              CNV_freq_filter=0.01,
                                                                              ds='SSC')
write_yaml(SPARKWGS3_parent_proband_SNVsExonicSizes, "SPARKWGS3_parent_US_SNVsExonicSizes.yaml")
