...
CNVs_10Percent <- CNVfilter.procedure(CNVfile.path = "/hpf/largeprojects/tcagstor/tcagstor_tmp/farazali/SSC/SVs/SVs.SSC.freq_1percent.HQR.IntFreq.tsv")
...
Get_CH_Events(probands = probands_10P,
  ...
  write_yaml(.,"SSC_CH_Data_SV1P_SNV.yaml")
...
Get_CH_Events(probands = Unaffected_siblings10P,
              CNVdf = CNVs_10Percent,
              SNVfolder = "exonic_splicing") %>%
  write_yaml(.,"SSC_CH.unaffectedSiblings_Data_SV1P_SNV.yaml")
